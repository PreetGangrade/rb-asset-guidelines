...
(function(){
  ...
  if (heroMode === 'orbit' && document.querySelector('.hero-orbit')){
    var HO_FIELD = [
      { x:   551, y:    -2, w: 104, h:  69 , src: 'assets/img/ex-rbtv-1-960.webp' },
      { x:  -439, y:   191, w:  85, h:  85 , src: 'assets/img/ex-stv-3-960.webp' },
      { x:    52, y:  -334, w:  69, h: 104 , src: 'assets/img/ex-rally-1-960.webp' },
      { x:   368, y:   273, w:  98, h:  73 , src: 'assets/img/ex-rbtv-5-960.webp' },
      { x:  -606, y:   -47, w:  76, h:  95 , src: 'assets/img/ex-stv-2-960.webp' },
      { x:   524, y:  -190, w: 113, h:  64 , src: 'assets/img/ex-rally-3-960.webp' },
      { x:  -176, y:   357, w:  95, h:  76 , src: 'assets/img/ex-rbtv-2-960.webp' },
      { x:  -308, y:  -325, w:  64, h: 113 , src: 'assets/img/ex-stv-5-960.webp' },
      { x:   675, y:   142, w: 104, h:  69 , src: 'assets/img/ex-rally-4-960.webp' },
      { x:  -638, y:   140, w:  85, h:  85 , src: 'assets/img/ex-rbtv-6-960.webp' },
      { x:   312, y:  -361, w:  69, h: 104 , src: 'assets/img/ex-stv-1-960.webp' },
      { x:   219, y:   398, w:  98, h:  73 , src: 'assets/img/ex-rally-2-960.webp' },
      { x:  -655, y:  -230, w:  76, h:  95 , src: 'assets/img/ex-rbtv-3-960.webp' },
      { x:   732, y:   -81, w: 113, h:  64 , src: 'assets/img/ex-stv-4-960.webp' },
      { x:  -472, y:   378, w:  95, h:  76 , src: 'assets/img/ex-rally-5-960.webp' },
      { x:  -102, y:  -446, w:  64, h: 113 , src: 'assets/img/ex-rbtv-4-960.webp' },
      { x:   604, y:   318, w: 104, h:  69 , src: 'assets/img/stage-rbtv-1070.webp' },
      { x:  -810, y:    21, w:  85, h:  85 , src: 'assets/img/stage-stv-1070.webp' },
      { x:   596, y:  -366, w:  69, h: 104 , src: 'assets/img/stage-rally-1070.webp' },
      { x:   -33, y:   483, w:  98, h:  73 , src: 'assets/img/tv-screen-rbtv-1100.webp' },
      { x:  -539, y:  -380, w:  76, h:  95 , src: 'assets/img/ex-rbtv-1-960.webp' },
      { x:   854, y:    65, w: 113, h:  64 , src: 'assets/img/ex-stv-3-960.webp' },
      { x:  -729, y:   307, w:  95, h:  76 , src: 'assets/img/ex-rally-1-960.webp' },
      { x:   186, y:  -503, w:  64, h: 113 , src: 'assets/img/ex-rbtv-5-960.webp' },
      { x:   447, y:   446, w: 104, h:  69 , src: 'assets/img/ex-stv-2-960.webp' },
      { x:  -867, y:  -160, w:  85, h:  85 , src: 'assets/img/ex-rally-3-960.webp' },
      { x:   845, y:  -233, w:  69, h: 104 , src: 'assets/img/ex-rbtv-2-960.webp' },
      { x:  -336, y:   510, w:  98, h:  73 , src: 'assets/img/ex-stv-5-960.webp' },
      { x:  -315, y:  -514, w:  76, h:  95 , src: 'assets/img/ex-rally-4-960.webp' },
      { x:   843, y:   254, w: 113, h:  64 , src: 'assets/img/ex-rbtv-6-960.webp' },
    ];
    ...
    /* exit: copy lifts through the glow, then the page melts into the blue hole */
    gsap.timeline({
      scrollTrigger: { trigger: '.hero-orbit', start: 'top top', end: 'bottom bottom', scrub: .8 },
      defaults: { ease: 'none' }
    })
      .to('.ho-copy', { y: -70, autoAlpha: 0, duration: .4 }, .3)
      .to('.ho-glow', { autoAlpha: 0, scale: .6, duration: .4 }, .34)
      .fromTo(['.ho-sticky', '.hero-orbit'], { backgroundColor: '#ffffff' }, { backgroundColor: '#000f1e', duration: .3, immediateRender: false }, .6);
